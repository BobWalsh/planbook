  ...
  var Collapse = function () {
    ...
    Collapse.prototype.show = function show() {
      ...
      var complete = function complete() {
        $(_this5._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE).addClass(ClassName.ACTIVE);

        _this5._element.style[dimension] = '';

        _this5.setTransitioning(false);

        $(_this5._element).trigger(Event.SHOWN);
      };
    ...
    Collapse.prototype.hide = function hide() {
      ...
      var complete = function complete() {
        ...
        $(_this6._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE).trigger(Event.HIDDEN);
      };
    ...
    Collapse.prototype._getParent = function _getParent() {
      ...
      $(parent).find(selector).each(function (i, element) {
        _this7._addAriaAndCollapsedClass(Collapse._getTargetFromElement(element), [element]);
      });
    ...
    Modal.prototype._setResizeEvent = function _setResizeEvent() {
      ...
      if (this._isShown) {
        $(window).on(Event.RESIZE, function (event) {
          return _this13._handleUpdate(event);
        });
      } else {
...
var Tooltip = function ($) {
  ...
  var Tooltip = function () {
    ...
    Tooltip.prototype.hide = function hide(callback) {
      ...
      var complete = function complete() {
        if (_this18._hoverState !== HoverState.ACTIVE && tip.parentNode) {
    ...
    Tooltip.prototype._setListeners = function _setListeners() {
      ...
      triggers.forEach(function (trigger) {
        if (trigger === 'click') {
          $(_this19.element).on(_this19.constructor.Event.CLICK, _this19.config.selector, function (event) {
            return _this19.toggle(event);
          });
          ...
          $(_this19.element).on(eventIn, _this19.config.selector, function (event) {
            return _this19._enter(event);
          }).on(eventOut, _this19.config.selector, function (event) {
            return _this19._leave(event);
          });
        }

        $(_this19.element).closest('.modal').on('hide.bs.modal', function () {
          return _this19.hide();
        });
      });
